            ...
            createDetail: function (element, data, createGroupedDetail, separatorChar, classes) {
                ...
                for (var group in groups) {
                    ...
                    for (var j = 0; j < groups[group].data.length; j++) {
                        ...
                        //--- tungdt ---
                        //replace the angular ng-element
                        if (groups[group].data[j].value.length > 0){
                        	element.find("div." + classes.detailInnerValue + ":last").html("").append(groups[group].data[j].value);
                        }
                    }
                }
            },
